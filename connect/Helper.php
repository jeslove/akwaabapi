    ...
    static private function find_contents($dir){
        ...
        foreach($root as $value){
            ...
            if(is_file($dir.DS.$value)){
                if(!self::$ext_filter || in_array(strtolower(pathinfo($dir.DS.$value, PATHINFO_EXTENSION)), self::$ext_filter)){
                    self::$files[] = $result[] = $dir.DS.$value;
                }
                continue;
            }
            if(self::$recursive){
                foreach(self::find_contents($dir.DS.$value) as $value) {
...
// $db = "digichor_tesanotbc";

// $pass ="eR)r4RC^6c4n";

// $username ="digichor_tbchurch";
